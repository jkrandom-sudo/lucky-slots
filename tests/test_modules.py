...
class TestI18n(unittest.TestCase):
    def test_translation_and_fallback(self):
        self.assertEqual(i18n.t("en", "title"), "Lucky Slots")
        self.assertEqual(i18n.t("zh", "title"), "幸运老虎机")
        self.assertEqual(i18n.t("missing", "title"), "Lucky Slots")
        self.assertEqual(i18n.t("en", "missing"), "missing")

    def test_formatting_error_returns_text(self):
        self.assertEqual(i18n.t("en", "finished"), "Finished with {coins} coins. Score {score}. Rating: {rating}")
